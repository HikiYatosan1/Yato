...
export const siteScenarioCards: ScenarioCard[] = [
  {
    title: "Квартира XPON",
    description: "Тарифы для многоквартирных домов с высокой скоростью и стабильным домашним Wi‑Fi.",
  ...
  {
    title: "Квартира FTTH",
    description: "Отдельная линейка FTTH для адресов, где доступна эта технология подключения.",
...
export const siteFeatures: FeatureItem[] = [
  {
    ...
    description: "На главной сразу видно тарифы для квартиры, FTTH-линейку, частный дом и пакетные предложения.",
    icon: Cable,
...
export const siteTariffs: Tariff[] = [
  ...
  {
    id: "xpon-radost",
    name: "Хочу радость XPON",
    category: "xpon",
    speed: "100 Мбит/с",
    price: "720 ₽/мес",
    description: "Базовый XPON-тариф для квартиры и повседневных задач.",
    features: ["XPON-подключение", "Безлимитный интернет", "Для квартиры"],
  },
  {
    id: "xpon-vostorg",
    name: "Хочу восторг XPON",
    category: "xpon",
    speed: "150 Мбит/с",
    price: "830 ₽/мес",
  ...
  {
    id: "xpon-schastye",
    name: "Хочу счастье XPON",
    category: "xpon",
    speed: "500 Мбит/с",
    price: "1 100 ₽/мес",
    description: "Максимально быстрый XPON-тариф для квартиры.",
  ...
  {
    id: "ftth-min",
    name: "Минимальный FTTH",
    category: "ftth",
    speed: "50 Мбит/с",
    price: "550 ₽/мес",
    oldPrice: "850 ₽/мес",
    description: "Базовый FTTH-тариф для домашнего подключения и привычных онлайн-задач.",
    features: ["FTTH-подключение", "Безлимитный интернет", "Для умеренной нагрузки"],
    badge: "Популярный",
    popular: true,
  },
  {
    id: "ftth-opt",
    name: "Оптимальный FTTH",
    category: "ftth",
    speed: "100 Мбит/с",
    price: "690 ₽/мес",
    oldPrice: "990 ₽/мес",
  ...
  },
  {
    ...
    price: "715 ₽/мес",
    oldPrice: "980 ₽/мес",
    description: "Пакет FTTH + ТВ для базового домашнего сценария.",
  ...
  {
    id: "bundle-radost",
    name: "Особенная радость XPON",
    category: "bundle",
    speed: "100 Мбит/с",
    price: "800 ₽/мес",
    description: "Пакет XPON и телевидения для квартиры с одним подключением.",
    features: ["181 ТВ-канал", "Архив передач", "Для квартиры"],
  },
  {
    id: "bundle-vostorg",
    name: "Особенный восторг XPON",
    category: "bundle",
    speed: "150 Мбит/с",
    price: "970 ₽/мес",
